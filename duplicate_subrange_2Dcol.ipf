...
Macro duplicate_subrange_2Dcol()

pduplicate_subrange_2Dcol()

proc pduplicate_subrange_2Dcol(str_input,str_startrow,str_endrow,str_output)
string str_input
prompt str_input "input waves ?"
string str_startrow
prompt str_startrow "start col ?"
string str_endrow
prompt str_endrow "end col ?"
string str_output
