...
var_index = 0
do
	duplicate $stringfromlist(var_index,str_list), $(stringfromlist(var_index,str_list)+"_n")
	wavestats/q/r=(xcsr(A),xcsr(B)) $stringfromlist(var_index,str_list)
	$(stringfromlist(var_index,str_list)+"_n") = $stringfromlist(var_index,str_list)*100/v_avg
	var_index+=1
