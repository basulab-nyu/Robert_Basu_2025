...
macro array_group_concat_scale_interp_avg_folders()

parray_group_concat_scale_interp_avg_folders()
proc parray_group_concat_scale_interp_avg_folders()
...
do
	string/g str_Fbrowse = stringfromlist(var_Findex,str_Flist)
	print "\n"+str_Fbrowse
	...
	killwaves/z wref
	setdatafolder root:
	duplicate/o wref wrefsub
	movestring str_name, root:$(str_Fbrowse):
	movewave wrefsub, root:$(str_Fbrowse):
	setdatafolder(str_Fbrowse)
// insert code to be ran here
variable/g var_timer2 = StartMSTimer
print "\nworking on: "+str_name
//setting up groups
string/g str_input = "wrefsub"
...
print "\ndone, runtime = "+num2str(stopMSTimer(var_timer2)/1000000)+"s"
// end code to be ran here
	setdatafolder root:
	var_Findex+=1
while(var_Findex<itemsinlist(str_Flist))
resumeupdate
print "\ndata analyzed!!!"
